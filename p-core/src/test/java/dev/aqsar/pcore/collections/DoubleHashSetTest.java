...
class DoubleHashSetTest {
    ...
    class BasicOperations {
        ...
        @BeforeEach
        void setUp() {
            set = DoubleHashSet.builder().build();
        }
        ...
        void testAddBoxedNull() {
            assertThrows(NullPointerException.class, () -> set.add((Double) null));
        }
    ...
    class BulkOperations {
        ...
        void testForEach() {
            ...
            double[] sum = {0};
            set.forEachDouble(value -> sum[0] += value);
        ...
        void testForEachEmpty() {
            double[] count = {0};
            set.forEachDouble(value -> count[0]++);
        ...
        void testForEachNull() {
            set.add(10);
            assertThrows(NullPointerException.class, () -> set.forEachDouble(null));
        }
    ...
    class CapacityManagement {
        ...
        void testAutoGrow() {
            DoubleHashSet set = DoubleHashSet.builder().initialCapacity(4).build();
        ...
        void testInitialCapacity() {
            DoubleHashSet set = DoubleHashSet.builder().initialCapacity(100).build();
        ...
        void testEnsureCapacity() {
            DoubleHashSet set = DoubleHashSet.builder().initialCapacity(8).build();
        ...
        void testLargeCapacity() {
            DoubleHashSet set = DoubleHashSet.builder().initialCapacity(1024).build();
        ...
        void testLoadFactor() {
            DoubleHashSet set = DoubleHashSet.builder().initialCapacity(16).loadFactor(0.5f).build();
    ...
    class IteratorPoolTests {
        ...
        void testBorrowReturn() {
            ...
            DoubleHashSet.DoubleHashSetIterator iter = set.borrowIterator();
            assertNotNull(iter);
        ...
        void testIterateAll() {
            ...
            try (DoubleHashSet.DoubleHashSetIterator iter = set.borrowIterator()) {
                while (iter.hasNext()) {
                    sum += iter.next();
                    count++;
                }
        ...
        void testPeek() {
            try (DoubleHashSet.DoubleHashSetIterator iter = set.borrowIterator()) {
                ...
                double peeked = iter.peekNext();
                double actual = iter.next();
        ...
        void testPoolExhaustion() {
            DoubleHashSet.DoubleHashSetIterator[] iters = new DoubleHashSet.DoubleHashSetIterator[8];
        ...
        void testReturnWrongIterator() {
            DoubleHashSet set2 = DoubleHashSet.builder().build();
            set2.add(1);
    ...
    class BoxedIteratorTests {
        ...
        void testBoxedIteratorEmpty() {
            DoubleHashSet emptySet = DoubleHashSet.builder().build();
            Iterator<Double> iter = emptySet.iterator();
    ...
    class BuilderConfiguration {
        ...
        void testDefaults() {
            DoubleHashSet set = DoubleHashSet.builder().build();
        ...
        void testDisableIteratorPool() {
            DoubleHashSet set = DoubleHashSet.builder().disableIteratorPool().build();
        ...
        void testFullConfiguration() {
            DoubleHashSet set = DoubleHashSet.builder().initialCapacity(50).loadFactor(0.6f).disableIteratorPool().build();
        ...
        void testBuilderChaining() {
            DoubleHashSet set = DoubleHashSet.builder().initialCapacity(10).loadFactor(0.75f).build();
    ...
    class EdgeCases {
        ...
        void testPowerOf2Boundaries() {
            DoubleHashSet set = DoubleHashSet.builder().initialCapacity(16).build();
        ...
        void testNonPowerOf2InitialCapacity() {
            DoubleHashSet set = DoubleHashSet.builder().initialCapacity(10).build();
